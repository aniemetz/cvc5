...
class AbstractionLemma
{
 public:
   ...
   * @param val_x The model value of x.
   * @param val_s The model value of s.
   * @param val_t The model value of t.
   * @param x     The x operand.
   * @param s     The s operand.
   * @param t     The t operand.
   * @return The instantiation of the lemma.
  ...
  virtual Node instance(
      TNode valX, TNode valS, TNode valT, TNode x, TNode s, TNode t) const;
...
class Lemma : public AbstractionLemma
{
 public:
  ...
  Node instance(CVC5_UNUSED TNode val_x,
