...
; SCRUBBER: grep -o "Parse Error: non_well_founded_dts.smt2:7.490: Datatype sort _dt5 is not well-founded"
; EXPECT: Parse Error: non_well_founded_dts.smt2:7.490: Datatype sort _dt5 is not well-founded
; EXIT: 1
